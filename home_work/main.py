...
def load_data_to_mongo(file_name, model_class):
    with open(file_name, encoding='utf-8') as fd:
        ...
        for entry in data:
            try:
                ...
                print(f"Дані вже існують в базі: {entry}")
...
if __name__ == '__main__':
    ...
    process.start()
    load_data_to_mongo('quotes.json', Quote)
    load_data_to_mongo('authors.json', Author)
